...
<br/>
  <ul  className='navLI'
  style={{display:"flex", flexDirection:"column",justifyContent:"space-between",textAlign:"center",width:'100%',height:"20rem"}}>
    <li><HomeIcon fontSize="large"/>Home</li>
    <li><InfoIcon fontSize="large"/> About</li>
    <li> <AccountBoxIcon fontSize='large'/>Profile</li>
  </ul>
<br/>
<hr/>
<br/>
<li style={{width:"10rem", height:"5rem",display:"flex", justifyContent:"space-evenly", padding:"2rem 0"}}><LogoutIcon fontSize='large'/>Log out</li>
    </ul>
